...
export default function ListProduct () {
  ...
  async function fetchListProduct () {
    const response = await axios.get('https://zs5utiv3ul.execute-api.us-east-1.amazonaws.com/dev/products')
    ...
    <div className="container-list-product">
      ...
      <ul>
        {products.map(product => {
          const precoNumber = `${product.price.to.integers},${product.price.to.decimals}`
          const precoMoeda = precoNumber
